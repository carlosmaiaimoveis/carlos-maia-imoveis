...
export default function CarlosMaiaImoveis() {
      ...
      <section className="py-20 md:py-28 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
            <div>
              <div className="font-body text-xs uppercase tracking-widest text-stone-500 mb-3">Selecionados</div>
              <h2 className="font-display text-4xl md:text-5xl text-stone-900 max-w-2xl leading-tight">
                Imóveis em <span className="italic font-light text-[#b85c3d]">destaque</span>
              </h2>
            </div>
            <button onClick={() => scrollTo("imoveis")} className="font-body text-sm text-stone-700 hover:text-stone-900 flex items-center gap-2 group">
              Ver todos os imóveis <ArrowRight size={16} className="group-hover:translate-x-1 transition"/>
            </button>
          </div>
